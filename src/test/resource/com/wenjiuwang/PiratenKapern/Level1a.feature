...
Feature: LEVEL 1a: BASIC DYING and SCORING
	...
	Given A 1 round game is running with rigged dice rolls "6,6,6,4,4,5,5,5", fortune "5" and fortune indicator "0"
	...
	Given A 1 round game is running with rigged dice rolls "6,4,4,4,4,5,5,5/6,6,5", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "6,6,4,4,4,4,5,5/6,5", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "6,4,4,4,4,5,5,5/6,3,3/6,3", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 reroll dice at position "6,7,8"
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "6,3,3,4,1,1,2,2", fortune "2" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "6,3,3,4,4,5,5,6/3,4", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "3,3,3,4,5,5,5,6", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "3,3,5,4,4,4,5,6/3,4", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "1,1,1,4,4,3,3,6", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "2,2,2,2,4,3,3,6", fortune "6" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "5,5,5,4,4,4,4,6", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "2,2,2,5,5,5,5,6", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	And Player 1 has scored 800
	...
	Given A 1 round game is running with rigged dice rolls "2,2,2,5,5,5,5,6", fortune "2" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "3,2,3,3,5,5,5,6/5,4/5,6", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 reroll dice at position "3,4"
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "3,3,3,3,5,3,3,6", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "4,4,4,4,4,4,4,6", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "2,2,2,2,2,2,2,2", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "2,2,2,2,2,2,2,2", fortune "6" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	And Player 1 has scored 5400
	...
	Given A 1 round game is running with rigged dice rolls "5,5,5,5,5,5,5,5", fortune "2" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "3,3,3,3,3,3,3,3", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	...
	Given A 1 round game is running with rigged dice rolls "3,4,5,3,4,5,6,1/6,1", fortune "6" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 reroll dice at position "1,2"
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "3,4,5,3,4,5,6,1/1,1", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 reroll dice at position "1,2"
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "3,4,5,3,4,5,6,2/2,2", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 reroll dice at position "1,2"
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "3,4,5,3,4,5,6,2/2,2", fortune "6" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 reroll dice at position "1,2"
	And Player 1 inspect new rolled dice
	...
	Given A 1 round game is running with rigged dice rolls "3,3,3,3,2,5,6,2", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
	And Player 1 end current round and score
	And Player 1 has scored 600
	...
	Given A 1 round game is running with rigged dice rolls "5,5,5,5,5,5,5,2", fortune "5" and fortune indicator "0"
	Then Three players join the game
	And Player 1 inspect new rolled dice
